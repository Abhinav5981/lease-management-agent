...
-- =============================================================================
-- SAMPLE DATA (representative, not exhaustive)
-- =============================================================================

-- Sample building
INSERT INTO buildings (id, name, address_line1, area, total_floors, total_units)
VALUES (
    'b1000000-0000-0000-0000-000000000001',
    'Marina Heights Tower B',
    'Plot 7, Al Marsa Street',
    'Dubai Marina',
    35,
    140
);
...
-- Sample units
INSERT INTO units (id, building_id, unit_number, floor_number, unit_type, bedrooms, bathrooms, area_sqft, status)
VALUES
    ('u1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', '804', 8,  '2br',    2, 2, 1150.00, 'occupied'),
    ('u1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', '312', 3,  'studio', 0, 1,  480.00, 'occupied'),
    ('u1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000001', '901', 9,  '1br',    1, 1,  750.00, 'occupied'),
    ('u1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000001', '1502',15, '2br',    2, 2, 1200.00, 'available');

-- Sample tenants
INSERT INTO tenants (id, first_name, last_name, email, phone, nationality, passport_number, passport_expiry, emirates_id, emirates_id_expiry, visa_type, employer_name, monthly_income_aed)
VALUES
    ('t1000000-0000-0000-0000-000000000001', 'Ahmad',  'Al Mansouri', 'ahmad@example.com',  '+971501234567', 'Indian',   'P1234567', '2029-03-15', '784-1990-1234567-1', '2027-06-01', 'Employment Residence', 'TechCorp LLC',     15000),
    ('t1000000-0000-0000-0000-000000000002', 'Priya',  'Sharma',      'priya@example.com',  '+971502345678', 'Indian',   'P2345678', '2027-11-20', '784-1992-2345678-2', '2026-09-15', 'Employment Residence', 'Emirates NBD',     10000),
    ('t1000000-0000-0000-0000-000000000003', 'Maria',  'Santos',      'maria@example.com',  '+971503456789', 'Filipino', 'P3456789', '2028-05-10', '784-1988-3456789-3', '2027-01-30', 'Employment Residence', 'Dubai Holdings',   18000),
    ('t1000000-0000-0000-0000-000000000004', 'Carlos', 'Mendez',      'carlos@example.com', '+971504567890', 'Spanish',  'P4567890', '2026-08-01', '784-1985-4567890-4', '2026-07-31', 'Employment Residence', 'Carrefour UAE',    12000);

-- Sample leases
INSERT INTO leases (id, lease_number, unit_id, tenant_id, start_date, end_date, annual_rent_aed, status, ejari_number, ejari_registration_date, signed_by_tenant_at, signed_by_company_at)
VALUES
    ('l1000000-0000-0000-0000-000000000001', 'LSE-2025-000001', 'u1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001', '2025-07-01', '2026-06-30', 95000,  'active', 'EJ-20250101-001', '2025-07-03', '2025-06-28 10:00:00+04', '2025-06-28 14:00:00+04'),
    ('l1000000-0000-0000-0000-000000000002', 'LSE-2025-000002', 'u1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000002', '2025-10-01', '2026-09-30', 52000,  'active', 'EJ-20251001-002', '2025-10-02', '2025-09-29 09:00:00+04', '2025-09-29 11:00:00+04'),
    ('l1000000-0000-0000-0000-000000000003', 'LSE-2025-000003', 'u1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000003', '2022-10-01', '2026-09-30', 85000,  'active', 'EJ-20221001-003', '2022-10-03', '2022-09-28 10:00:00+04', '2022-09-28 12:00:00+04'),
    ('l1000000-0000-0000-0000-000000000004', 'LSE-2025-000004', 'u1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000004', '2025-08-01', '2026-07-31', 70000,  'active', 'EJ-20250801-004', '2025-08-02', '2025-07-30 10:00:00+04', '2025-07-30 15:00:00+04');

-- Sample maintenance request
INSERT INTO maintenance_requests (id, reference_number, unit_id, lease_id, tenant_id, category, priority, status, title, description, sla_due_at)
VALUES (
    ...
    'high',
    'assigned',
    'AC not working - Studio 312',
    'The air conditioning unit is not cooling. Tenant reports temperature above 30C in unit.',
    NOW() + INTERVAL '6 hours'
);

-- Sample renewal (Maria, Unit 901, lease ends 2026-09-30)
INSERT INTO renewals (id, lease_id, tenant_id, unit_id, new_start_date, new_end_date, previous_rent_aed, proposed_rent_aed, rera_permitted_increase_pct, rera_max_rent_aed, rera_index_checked_at, notice_due_by, status)
VALUES (
    ...
    '2027-09-30',
    85000.00,
    89250.00,   -- 5% RERA-permitted increase
    5.00,
    89250.00,
    '2026-06-17 09:00:00+04',
    '2026-07-02',  -- 90 days before 2026-09-30
    'offered'
);
